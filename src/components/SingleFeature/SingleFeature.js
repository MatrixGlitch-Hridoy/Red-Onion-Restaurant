                ...
                <div className="card-body">
                    <div className="d-flex">
                        ...
                        <div>
                            ...
                            {
                                descriptionCollapse? 
                                <span onClick={showLess} className="card-link collapse-btn">See Less <BiLeftArrowAlt className="icon"/></span>
                                :
                                <span onClick={showMore} className="card-link collapse-btn">See More <BiRightArrowAlt className="icon"/></span>
                            }
                        </div>
                    </div>
                </div>
